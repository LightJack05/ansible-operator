...
type AnsiblePlaybookStatus struct {
	...
	// conditions represent the current state of the AnsiblePlaybook resource.
...
type AnsiblePlaybook struct {
	...
	// spec defines the desired state of AnsiblePlaybook
	// +required
	Spec AnsiblePlaybookSpec `json:"spec"`

	// status defines the observed state of AnsiblePlaybook
	// +optional
	Status AnsiblePlaybookStatus `json:"status,omitzero"`
}
