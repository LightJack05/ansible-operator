...
var _ = Describe("Manager", Ordered, func() {
	...
	// The manager namespace, CRDs and controller-manager deployment are
	// created once for the whole suite in SynchronizedBeforeSuite.

	// After all tests have been executed, clean up the resources created by the metrics test.
	AfterAll(func() {
